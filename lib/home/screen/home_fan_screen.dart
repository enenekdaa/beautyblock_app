...
import 'package:beautyblock_app/home/main_bottom_navbar_tab/local_widget/scaffold/tab_channel_screen_scaffold.dart';
import 'package:beautyblock_app/utils.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class HomeFanScreen extends StatelessWidget {
  const HomeFanScreen({super.key});
  ...
  Widget _buildListview() {
    return Expanded(
      child: ListView(
        ...
        children: RankingController.to.filteredChannels
