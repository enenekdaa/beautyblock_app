...
class CustomGroupDropDownWidget extends StatelessWidget {
  CustomGroupDropDownWidget(
      {Key? key,
   ...
   List<DropdownMenuItem<String>> widgetList =[];
    if(itemList != null){
      ...
      widgetList.add(DropdownMenuItem(
        value: value.id,
        child: Text(value.group,style: AppTheme.smallTitleTextStyle.copyWith(fontSize: 14,fontWeight: FontWeight.w400),),
      ));
      });
    }
